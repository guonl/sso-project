package com.guonl.app.test;

import com.guonl.app.test.util.HttpClientUtil;
...
/**
 * Created by guonl
 * Date 2018/4/17 上午11:03
 * Description:
 */
public class TokenClientTest {
	private static Logger logger = LoggerFactory.getLogger(TokenClientTest.class);

	public static String ssoServer = "http://ssoserver.com:8080/sso-server";

	public static String client01 = "http://ssoclient1.com:8082/sso-token-sample-springboot/";
	public static String client02 = "http://ssoclient2.com:8082/sso-token-sample-springboot/";
